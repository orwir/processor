...
public class DictionaryHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            values.put(DictionaryContract.Dictionary.Col.NAME, getContext().getString(R.string.label_default));
            db.insert(DictionaryContract.Dictionary.TABLE_NAME, null, values);
